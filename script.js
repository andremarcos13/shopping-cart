...
// addEventListener(console.log('xxx'));
// btnAdd.addEventListener('click', function () {
//   const getItemSku = document.getElementsByClassName('.item__sku').value;
//   console.log(getItemSku);
//   // event.target.alert(getGrandFather);
//   // console.log('xxx');
// });
